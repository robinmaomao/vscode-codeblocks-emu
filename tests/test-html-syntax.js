...
const distPath = path.resolve(__dirname, '../dist/ui/projectPropertiesPanel.js');
...
const project = new ProjectParser().parse(path.join(__dirname, '../test-project/hello-cb.cbp'));
